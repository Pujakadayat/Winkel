...
import 'package:winkle_final/provider/size_provider.dart';

import '../navscreen.dart/widgets/product_models.dart';

class ProductDetail extends ConsumerStatefulWidget {
  final dynamic productData;

  const ProductDetail({Key? key, this.productData, required List reviews}) : super(key: key);
