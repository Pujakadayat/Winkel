...
import 'package:winkle_final/payment/api.dart';
import 'package:winkle_final/payment/khaltipayment.dart';
import 'package:winkle_final/models/cart_attributes.dart';
import 'package:winkle_final/provider/cart_provider.dart';
import 'package:winkle_final/provider/product_provider.dart';
import 'package:winkle_final/provider/smtp.dart';
import 'package:winkle_final/views/buyers/inner_screens/deliveryboy_screen.dart';
...
//   // Modify the constructor to accept selectedTotalPrice
//   CheckoutScreen({required this.selectedTotalPrice});
                        ...
                        if (selectedPaymentOption == 'Khalti') {
                          ...
                          await Future.forEach(
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                    'Order has been placed. Payment will be Cash on Delivery.'),
                                duration: Duration(
                                    seconds:
                                        3), // Customize how long the Snackbar shows
                              ),
                            );
                            setState(() {
                              _isLoading = false;
