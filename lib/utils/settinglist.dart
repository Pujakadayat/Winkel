...
class SettingsListData {
  ...
  static List<SettingsListData> helpSearchList = [
    SettingsListData(
      titleTxt: "paying_for_a_orders",
      subTxt: "",
    ),
    SettingsListData(
      titleTxt: '',
      subTxt: "How do I contact vendor ",
    ),
    SettingsListData(
      titleTxt: '',
      subTxt: "What are the delivery charge? ",
    ),
    SettingsListData(
      titleTxt: '',
  ...
  static List<SettingsListData> subHelpList = [
    ...
    SettingsListData(
      titleTxt: "",
      subTxt: "GO to orders and choose your order",
    ),
